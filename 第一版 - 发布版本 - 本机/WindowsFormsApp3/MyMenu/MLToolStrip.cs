...
namespace MyMenu
{
    ...
    /// MLToolStrip工具栏
    /// </summary>
    [Description("MLToolStrip工具栏")]
    [ToolboxItem(true)]
    public partial class MLToolStrip : ToolStrip
    {
        #region 重写属性
        ...
        public MLToolStrip()
        {
            ...
            this.Renderer = new MLToolStripRenderer(new MLToolStripColorTable());
        }
    ...
    /// MLToolStrip渲染器
    /// </summary>
    [Description("MLToolStrip渲染器")]
    public class MLToolStripRenderer : ToolStripProfessionalRenderer
    {
        #region 属性

        private MLToolStripColorTable colorTable;
        /// <summary>
        /// 用于绘制的调色板
        /// </summary>
        [Description("用于绘制的调色板")]
        public new MLToolStripColorTable ColorTable
        {
            get
            {
                if (this.colorTable == null)
                    this.colorTable = new MLToolStripColorTable();
        ...
        public MLToolStripRenderer() : base()
        {

        }

        public MLToolStripRenderer(MLToolStripColorTable customColorTable) : base(customColorTable)
        {
        ...
        {
            bool istop = ((e.ToolStrip is MLMenuStrip) || (e.ToolStrip is MLToolStrip) || (e.ToolStrip is MLStatusStrip));
    ...
    /// MLToolStrip调色板
    /// </summary>
    [Description("MLToolStrip调色板")]
    public class MLToolStripColorTable : ProfessionalColorTable
    {
        public MLToolStripColorTable() : base()
        {
        ...
        /// </summary>
        public override Color MenuItemSelected { get { return Color.FromArgb(111, 155, 244); } }
