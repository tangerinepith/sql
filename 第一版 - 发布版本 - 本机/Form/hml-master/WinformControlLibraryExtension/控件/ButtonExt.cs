...
namespace WinformControlLibraryExtension
{
    ...
    public class ButtonExt : Button, IAnimationStaticTimer
    {
        ...
        protected override void OnMouseEnter(EventArgs e)
        {
            ...
            this.LoadOriginal(this.original_isload);            //位置设置需要更改
            this.animationIntervalTypes = AnimationIntervalTypes.Add;
            AnimationStaticTimer.AnimationStart(this);          //执行动画
        }
        ...
        protected override void OnMouseLeave(EventArgs e)
        {
            ...
            this.animationIntervalTypes = AnimationIntervalTypes.Subtrac;     //AnimationIntervalTypes控制动画变换方向，sub是缩小，add是放大
        ...
        public void Animationing()
        {
            ...
            control.Location = new Point((int)this.original_x + x, (int)this.original_y + y);       //按钮位置（依据按钮父容器左上角相距位置）发生变更
        }
